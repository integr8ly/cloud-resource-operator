...
func Test_buildAWSWindows(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				timeConfig: &StrategyTimeConfig{
					...
					MaintenanceStartTime: "sun 21:01",
				},
			},
		...
		},
		{
			...
			args: args{
				timeConfig: &StrategyTimeConfig{
					BackupStartTime:      "1:05",
					MaintenanceStartTime: "sun 4:05",
				},
			},
		...
		},
		{
			...
			args: args{
				timeConfig: &StrategyTimeConfig{
					BackupStartTime:      "15:15",
					MaintenanceStartTime: "mon 23:05",
				},
			},
		...
		},
		{
			...
			args: args{
				timeConfig: &StrategyTimeConfig{
					BackupStartTime:      "15:15",
					MaintenanceStartTime: "mon 15:25",
				},
			},
			backupWant:      "",
			maintenanceWant: "",
		...
		},
		{
			...
			args: args{
				timeConfig: &StrategyTimeConfig{
					BackupStartTime:      "15:15",
					MaintenanceStartTime: "mon 14:25",
				},
			},
			backupWant:      "",
			maintenanceWant: "",
		...
		},
		{
			...
			args: args{
				timeConfig: &StrategyTimeConfig{
					BackupStartTime:      "15:15",
					MaintenanceStartTime: "mOnd 16:16",
				},
			},
			backupWant:      "15:15-16:15",
