...
// OpenTelemetry compatibility with gRPC v1.58.0 (marin3r constraint)
...
replace go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc => go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.24.0
